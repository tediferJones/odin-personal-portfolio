...
export default function CommandLineProjects({ repos }: { repos: Repo[]}) {
  ...
  return (
    <div id='CliProjects' className='bg-sky-600 w-full md:w-4/5 mb-12 md:rounded-xl overflow-clip scroll-mt-48 md:scroll-mt-32'>
      <h1 className='text-2xl text-gray-100 p-4'>Command Line Projects and Algorithms ({total})</h1>
